...
class TaskA2 {
    public static void main(String[] args) {
        String s ="В Париж! В Париж! Как сладко-странно";
        String a ="Ты, сердце, в этот миг стучишь!..";
        String b = "Прощайте, невские туманы,";
        String c = "Нева и Петр! – В Париж! В Париж!";
        String h = "Мое любимое стихотворение:";
